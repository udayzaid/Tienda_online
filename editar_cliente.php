...
<tr>
<br><br><p><h1><center>EDITAR CLIENTE</center></h1>
<form enctype="multipart/form-data" method=POST action="editar_cliente2.php">


<tr>
<td><font color=white>Id &nbsp;&nbsp;</font></td>
<td><input type=TEXT REQUIRED name="txtid" value="<?php echo $fila['id'];?>"/><br></td>
</tr>
<tr>
<td><font color=white>Nombre &nbsp;&nbsp;</font></td>
<td><input type=TEXT REQUIRED name="txtnombre" value="<?php echo $fila['nombre'];?>"/><br></td>
</tr>
<tr>
<td><font color=white>Apellido</font> </td>
<td><input type=TEXT REQUIRED name="txtapellido" value="<?php echo $fila['apellido'];?>"/><br></td>
</tr>
<tr>
<td><font color=white>Edad</font> </td>
<td><input type=TEXT REQUIRED name="txtedad" value="<?php echo $fila['edad'];?>"/><br></td>
</tr>
<tr>
<td><font color=white>Telefono</font> </td>
<td><input type=TEXT REQUIRED name="txttelefono" value="<?php echo $fila['telefono'];?>"/><br></td>
</tr>
<tr>
<td><font color=white>Direcci&oacute;n</font> </td>
<td><input type=TEXT REQUIRED name="txtdireccion" value="<?php echo $fila['direccion'];?>"/><br></td>
</tr>
<tr>
<td><font color=white>Pa&iacute;s</font> </td>
<td><input type=TEXT  REQUIRED name="txtpais" value="<?php echo $fila['pais'];?>"/><br></td>
</tr>
<tr>
<td><font color=white>Cuidad</font> </td>
<td><input type=TEXT   REQUIRED name="txtciudad" value="<?php echo $fila['ciudad'];?>"/><br></td>
</tr>
<tr>
<td><font color=white>E-Mail</font> </td>
<td><input type=TEXT REQUIRED name="txtcorreo" value="<?php echo $fila['correo'];?>"><br></td>
</tr>
<tr width=100%>
